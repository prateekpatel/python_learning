...
def lambda_handler(event, context):
    ...
    file_path = os.environ.get("file_path") + file_name
    ...
    try:
        ...
        if srv.isfile(file_path):
            srv.get(file_path, local_path)  # To download a file, replace put with get
            file_upload(file_path, bucket_name=bucket_name)
